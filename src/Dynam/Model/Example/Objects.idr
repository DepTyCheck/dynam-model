module Dynam.Model.Example.Objects
...
{- 3 -} NewV Str $ Literal "89"
        ...
        NewClass [True, True, False, False]
        
        NewObject 0

        NewV Boolean $ InvokeMethod 0 M2 [ Literal "" ]

        CallMethod 0 M1 [ Literal "ty" ]
        Ret
